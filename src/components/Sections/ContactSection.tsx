    ...
    <section className="py-20 bg-pure-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-hero-red to-transparent animate-shimmer" style={{ animationDelay: '1s' }} />
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <Input
                    ...
                    required
                    className="bg-muted border-border focus:border-hero-red text-foreground placeholder:text-muted-foreground"
                  />
                </div>
                ...
                <div>
                  <Textarea
                    ...
                    rows={6}
                    required
                    className="bg-muted border-border focus:border-hero-red text-foreground placeholder:text-muted-foreground resize-none"
                  />
                </div>
                ...
                <Button
                  ...
                  className="w-full bg-hero-red hover:bg-hero-red/90 text-pure-white font-semibold uppercase tracking-wide py-3 group"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="animate-slide-in-right">
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <a
                    href="mailto:hamza00990.khan@gmail.com"
                    className="flex items-center space-x-4 text-muted-foreground hover:text-hero-red transition-colors duration-300 group"
                  >
