...
const ToolsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-red-black relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-hero-red/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-pure-white/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-16 animate-on-scroll" style={{ animationDelay: '0.6s' }}>
            <p className="text-muted-foreground text-lg">
              Also proficient in <span className="text-hero-red font-semibold">React</span>, 
              {' '}<span className="text-hero-red font-semibold">Next.js</span>, 
              {' '}<span className="text-hero-red font-semibold">TypeScript</span>, and 
              {' '}<span className="text-hero-red font-semibold">Tailwind CSS</span>
            </p>
          </div>
        </div>
      </div>
